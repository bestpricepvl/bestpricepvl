...
class Prices(models.Model):
    ...
    datep = models.DateTimeField(_('The date'))
    store = models.CharField(_('Place of Purchase'), max_length=128)
    product = models.CharField(_('Product (commodity)'), max_length=256)
